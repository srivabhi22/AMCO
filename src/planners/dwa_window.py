...
class Ui_DWA_Simulator(object):
    def setupUi(self, DWA_Simulator):
        ...
        self.goal_weight_SpinBox = QtWidgets.QDoubleSpinBox(DWA_Simulator)
        self.goal_weight_SpinBox.setGeometry(QtCore.QRect(940, 197, 60, 25))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.goal_weight_SpinBox.setFont(font)
        self.goal_weight_SpinBox.setSingleStep(0.01)
        self.goal_weight_SpinBox.setMinimum(-99.9)
        self.goal_weight_SpinBox.setObjectName("goal_weight_SpinBox")
        self.surr_weight_SpinBox = QtWidgets.QDoubleSpinBox(DWA_Simulator)
        self.surr_weight_SpinBox.setGeometry(QtCore.QRect(940, 227, 60, 25))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.surr_weight_SpinBox.setFont(font)
        self.surr_weight_SpinBox.setDecimals(3)  # Set decimals first
        self.surr_weight_SpinBox.setMinimum(-99.999)  # Then set the minimum
        self.surr_weight_SpinBox.setSingleStep(0.001)  # Allow finer step size
        self.surr_weight_SpinBox.setObjectName("surr_weight_SpinBox")
        ...
        self.obstacle_weight_SpinBox.setMinimum(-99.9)
    ...
    def retranslateUi(self, DWA_Simulator):
        ...
        self.label_14.setText(_translate("DWA_Simulator", "goal weight"))
        self.label_15.setText(_translate("DWA_Simulator", "surr weight"))
